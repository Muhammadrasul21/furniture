    ...
    <nav className="bg-white">
      <div className="container max-w-[1332px] mx-auto px-4">
        <div className="flex justify-between py-4">
          ...
          <div className="flex justify-center w-full sm:w-auto sm:justify-end gap-6 text-[#454545]">
        ...
        <div className="flex items-center justify-between py-4 gap-4">
          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-center gap-1">
              ...
              <p className="text-xs hidden sm:block">Избранное </p>
            </div>
            <div className="hidden md:flex flex-col items-center gap-1 ">
              <FaSignal className="w-6 h-6" />
              <p className="text-xs hidden sm:block"> Сравнение</p>
            </div>
            <div className="flex flex-col items-center gap-1">
              <FaCartShopping className="w-5 h-6 " />
              <p className="text-xs hidden sm:block">Корзина</p>
            </div>
          </div>
        </div>
        {isMenuOpen && (
          <div className="sm:hidden bg-white p-4 absolute top-0 right-0 w-full z-10">
            ...
            <div className="flex gap-3 flex-col items-center">
              ...
              <p>8 (800) 890-46-56</p>
              <span className="opacity-50">Заказать звонок</span>
            </div>
          </div>
        )}
